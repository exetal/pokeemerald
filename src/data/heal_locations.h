static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 36, 18},
    [HEAL_LOCATION_STARRE_HARBOR - 1] = {MAP_GROUP(STARRE_HARBOR), MAP_NUM(STARRE_HARBOR), 15, 23},
};
